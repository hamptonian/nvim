...
local function setup_lsp_keymaps(e)
    ...
    vim.keymap.set("n", "<leader>vws", function() vim.lsp.buf.workspace_symbol() end, vim.tbl_extend("force", opts, { desc = "Workspace Symbol Search" }))
    -- Open diagnostics
    ...
    vim.keymap.set("n", "<leader>vca", function() vim.lsp.buf.code_action() end, vim.tbl_extend("force", opts, { desc = "Code Actions" }))
    -- References
...
vim.keymap.set("n", "<leader>pv", vim.cmd.Ex, { desc = "Project View (File Explorer)" })
vim.keymap.set('n', '<leader>pf', function() require('telescope.builtin').find_files() end, { desc = "Project Find Files" })
vim.keymap.set('n', '<C-p>', function() require('telescope.builtin').git_files() end, { desc = "Project Git Files" })
...
vim.keymap.set('n', '<leader>pr', function() require('telescope.builtin').oldfiles() end, { desc = "Project Recent Files" })
...
vim.keymap.set("n", "<leader>fo", function() require('telescope.builtin').vim_options() end, { desc = "Find Options" })
...
vim.keymap.set("n", "<leader>/", function() require('telescope.builtin').live_grep() end, { desc = "Live Grep Search" })
...
vim.keymap.set("n", "<leader>sb", function() require('telescope.builtin').current_buffer_fuzzy_find() end, { desc = "Search Buffer Lines" })

-- Advanced search operations
vim.keymap.set("n", "<leader>sr", function() require('grug-far').grug_far() end, { desc = "Search & Replace (GrugFar)" })
vim.keymap.set("n", "<leader>sc", function() require('telescope.builtin').commands() end, { desc = "Search Commands" })
vim.keymap.set("n", "<leader>sh", function() require('telescope.builtin').help_tags() end, { desc = "Search Help" })
...
vim.keymap.set("n", "<leader>uz", function() require("zen-mode").toggle() end, { desc = "Toggle Zen Mode" })
...
vim.keymap.set("n", "<leader>uw", function() vim.opt.wrap = not vim.opt.wrap:get() end, { desc = "Toggle Word Wrap" })
vim.keymap.set("n", "<leader>us", function() vim.opt.spell = not vim.opt.spell:get() end, { desc = "Toggle Spell Check" })
...
vim.keymap.set("n", "<leader>gh", function() require('telescope.builtin').git_commits() end, { desc = "Git History" })
...
vim.keymap.set("n", "<leader>bb", function() require('telescope.builtin').buffers() end, { desc = "Switch Buffers" })
